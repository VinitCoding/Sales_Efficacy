...
const Landing = () => {
  return (
    <div className="w-screen h-screen overflow-x-hidden">
      ...
      {/* About Section */}
      <div className="flex items-center justify-center gap-x-20 pt-[60px] relative z-0">
        <img src={bg_img} alt="insurance_img" className="w-[270px]" />
        <div className="w-[647px] flex flex-col gap-y-4">
          <h2 className="text-[40px] font-[700] w-[500px] leading-[50px]">
            Unlock Your <span className="text-[#FF540B]">Financial Potential</span> with Sales<span className="text-[#FF540B]">Assist</span>
          </h2>
          <p className="text-[18px] leading-[30px] w-[510px] tracking-wide">
            Get personalized and comprehensive recommendations from your <span className="font-semibold"><span className="text-[#FF540B]">AI-powered</span> companion.</span>
          </p>
          <LoginForm />
        </div>
      </div>
      ...
      {/* Features */}
      <h2 className="mt-10 text-xl font-semibold tracking-wide text-center underline underline-offset-4">
        {" "}
        Features{" "}
      </h2>
      <div className="overflow-x-hidden bg-white w-[95%] px-6 py-[19px] text-center mx-auto rounded mt-3 ">
        <div className="flex gap-x-6">
          <div className="bg-[#f5f5f5] flex flex-col items-center p-3 text-center rounded-lg shadow-lg  w-fit">
            <img src={feature_1} className="w-[70px]" />
            <h3 className="text-[20px] font-semibold pt-2">
              AI Recommendations
            </h3>
          ...
          <div className="bg-[#f5f5f5] shadow-md w-fit rounded-lg flex flex-col text-center p-3 items-center">
            <img src={feature_2} className="w-[70px]" />
            <h3 className="text-[20px] font-semibold pt-2">
              Easy Upload
            </h3>
            <p className="pt-2 tracking-wide">
          ...
          <div className="bg-[#f5f5f5] shadow-md w-fit rounded-lg flex flex-col text-center p-3 items-center">
            <img src={feature_3} className="w-[60px] mt-2" />
            <h3 className="text-[20px] font-semibold pt-3">
              Data Privacy
            </h3>
            <p className="pt-2 tracking-wide">
      ...
      {/* Footer */}
      <footer className="flex justify-center md:mt-5 lg:mt-5">
        <img src={powered_by} className="w-[170px]" />
      </footer>
    </div>
  );
};
